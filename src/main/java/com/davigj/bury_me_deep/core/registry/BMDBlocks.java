...
public class BMDBlocks {
    ...
    public static final RegistryObject<Block> RED_CURIOUS_ARID_SAND = HELPER.createBlock("red_curious_arid_sand", () -> new CuriousBlock(Block.Properties.copy(Blocks.SUSPICIOUS_SAND)));
